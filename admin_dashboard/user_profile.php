                                ...
                                <div class="card car-transparent">
                                    <div class="card-body p-0">
                                        <div class="profile-image position-relative">
                                            <img src="../assets/images/page-img/profile.png"
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body text-center">
                                        ...
                                        <h2 class="mb-2 mt-3 text-primary">12+</h2>
                                        <h4>Awards</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body text-center">
                                        ...
                                        <h2 class="mb-2 mt-3 text-success">1+ years </h2>
                                        <h4>Experience</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body text-center">
                                        ...
                                        <h2 class="mb-2 mt-3 text-warning">24+</h2>
                                        <h4>Participated</h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <ul class="list-inline p-0 m-0">
                                            ...
                                            <li class="d-flex align-items-center mb-5">
                                                ...
                                                <div class="pl-3">
                                                    <h5>Arid University</h5>
                                                    <p class="mb-0">Bachelor of Science in Computer Science | 2020</p>
                                                </div>
                                            </li>
                                            <li class="d-flex align-items-center mb-5">
                                                <div
                                                ...
                                                <div class="pl-3">
                                                    <h5>Concordia College</h5>
                                                    <p class="mb-0">Pre-Engineering | 2016</p>
                                                </div>
                                            </li>
                                        ...
                                        <div class="card card-block card-stretch card-height">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-inline p-0 mb-0">
                                                    <li>
                                                        <div
                                                            class="d-flex align-items-center justify-content-between mb-3 row">
                                                            <div class="col-10">
                                                                <div class="d-flex align-items-center">
                                                                    <p class="mb-0 font-size-16 mr-3">English</p>
                                                                    <div
                                                                        class="iq-progress-bar-linear d-inline-block iq-progress-height mt-1 w-80">
                                                            ...
                                                            <div class="col-2">
                                                                <div
                                                                    class="percentage float-right text-danger font-weight-bold">
                                                                    75%
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <div class="col-10">
                                                                <div class="d-flex align-items-center">
                                                                    <p class="mb-0 font-size-16 mr-3">Urdu</p>
                                                                    <div
                                                                        class="iq-progress-bar-linear d-inline-block iq-progress-height mt-1 w-80">
                                                            ...
                                                            <div class="col-2">
                                                                <div
                                                                    class="percentage float-right text-primary font-weight-bold">
                                                                    50%
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <div class="col-10">
                                                                <div class="d-flex align-items-center">
                                                                    <p class="mb-0 font-size-16 mr-3">Punjabi</p>
                                                                    <div
                                                                        class="iq-progress-bar-linear d-inline-block iq-progress-height mt-1 w-80">
                                                            ...
                                                            <div class="col-2">
                                                                <div
                                                                    class="percentage float-right text-success font-weight-bold">
                                                                    65%
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-body">
                                                <ul class="list-inline p-0 m-0">
                                                    <li class="mb-3 d-flex">
                                                        <span><i
                                                                class="lab la-facebook-f text-primary font-size-20 mr-3"></i></span>
                                                        <p class="mb-0 font-size-16 line-height">@asad/facebook.com</p>
                                                    </li>
                                                    <li class="mb-3 d-flex">
                                                        <span><i
                                                                class="lab la-twitter text-info font-size-20 mr-3"></i></span>
                                                        <p class="mb-0 font-size-16 line-height">@asad/twitter.com</p>
                                                    </li>
                                                    <li class=" d-flex">
                                                        <span><i
                                                                class="lab la-instagram  text-danger font-size-20 mr-3"></i></span>
                                                        <p class="mb-0 font-size-16 line-height">@asad/insta.com</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <ul class="list-inline mb-0 p-0">
                                                    ...
                                                    <li class="d-flex align-items-center">
                                                        <span
                                                            class="bg-warning-light rounded-small iq-card-icon-small mr-3">1</span>
                                                        <p class="mb-0 font-size-16">Junior Web Desginer
                                                            Solutions | 2020 - 2021</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="list-inline p-0 mb-0">
                                            <li>
                                                <div class="d-flex align-items-center justify-content-between mb-4 row">
                                                    <div class="col-lg-4">
                                                        <p class="mb-0 font-size-16">Html</p>
                                                    </div>
                                                    <div class="col-lg-8">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center justify-content-between mb-4 row">
                                                    <div class="col-lg-4">
                                                        <p class="mb-0 font-size-16">Bootstrap</p>
                                                    </div>
                                                    <div class="col-lg-8">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-inline p-0 m-0 iq-contact-rest">
                                            <li class="mb-3 d-flex">
                                                ...
                                                <p class="mb-0 font-size-16 line-height">435, 3, Pak Avenue Colony, Sahiwal.
                                                </p>
                                            </li>
                                            <li class="mb-3 d-flex">
                                                <span><i class="fas fa-phone-volume mr-3 font-size-20"></i></span>
                                                <p class="mb-0 font-size-16 line-height">+92 336 0656688</p>
                                            </li>
                                            <li class="mb-3 d-flex">
                                                <span><i class="fas fa-envelope-open mr-3 font-size-20"></i></span>
                                                <p class="mb-0 font-size-16 line-height"><a
                                                        href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                        data-cfemail="3c565354527c4c4e534c594e4845125f5351">asadullah4395@gmail.com</a>
                                                </p>
                                            </li>
                                            <li class="mb-3 d-flex">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <i class="fa fa-link  mr-3 font-size-20"></i>
                                                    <p class="mb-0 font-size-16 line-height">
                                                        http://www.asadrajput.com </p>
                                                </a>
                                            </li>
